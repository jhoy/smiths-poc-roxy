...
<div xmlns="http://www.w3.org/1999/xhtml" class="admin editreportdoc">
  <!--p>This file lives at: C:/MarkLogic/smiths-poc-roxy/src/app/views/admin/editreportdoc.html.xqy</p-->
  <!--p>{fn:string(vh:get("message"))}</p-->
  
<div style="width: 50%; float:left"> <p>{oh:edit-report-doc(vh:get("bookXMLUri"))}</p></div>
